...
export default function DisclaimerPage() {
  return (
    <div className="container min-h-screen section-gap lg:mt-0  md:mt-20 mt-28">
      <motion.div
            ...
            <CardContent className="space-y-4 text-text_default">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li className="flex items-center gap-2">
                  <AlertTriangle className="w-4 h-4" /> It may not account for your specific medical history
                </li>
                <li className="flex items-center gap-2">
                  <Stethoscope className="w-4 h-4" /> It cannot perform physical examinations
                </li>
                <li className="flex items-center gap-2">
                  <BookOpen className="w-4 h-4" /> It may not be aware of recent medical developments
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4" /> It cannot make definitive medical diagnoses
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-text_default">
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                <li className="flex items-center gap-2">
                  <Stethoscope className="w-4 h-4" /> Medical diagnosis
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4" /> Treatment recommendations
                </li>
                <li className="flex items-center gap-2">
                  <Shield className="w-4 h-4" /> Medication advice
                </li>
                <li className="flex items-center gap-2">
                  <HeartPulse className="w-4 h-4" /> Any specific health concerns
                </li>
              </ul>
