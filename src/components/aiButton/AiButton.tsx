  ...
  return (
    <div className="flex items-center justify-center">
      ...
      >
        ...
        <button className="relative px-6 py-[15px] bg-gray-950 rounded-full flex items-center gap-2 leading-none">
          <Sparkles className="w-4 h-4 text-white animate-pulse" />
          <span className="text-white font-medium">Meds AI</span>
        </button>
      </Link>
