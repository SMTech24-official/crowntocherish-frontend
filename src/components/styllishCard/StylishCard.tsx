...
export function StylishCard({
    ...
    return (
        <div className={`relative w-full ${height} max-w-md p-6 ${background} rounded-xl shadow-lg overflow-hidden hover:scale-[1.01] transition-all duration-300`}>
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <Button
                    className={`${buttonColor} ${buttonHoverColor} hover:text-text_title w-fit text-white transition-colors duration-200 border-text_title  hover:bg-white`}
                >
                    Learn More
                </Button>
            </div>
