    ...
    <section className="py-16 bg-[#FFF1F2]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#DB2777] mb-4">What Our Patients Say</h2>
          <p className="text-[#BE185D] text-lg max-w-2xl mx-auto">
            Read about the experiences of those who have trusted us with their healthcare needs.
          </p>
        </div>
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors duration-200 ${
                  currentIndex === index ? "bg-[#DB2777]" : "bg-[#FECDD3]"
                }`}
